...
function [Winput_min, Winterior_min, Wprev1_min, Wprev2_min, Woutput_min, error] = train_BP(X, Winput, Winterior, Wprev1, Wprev2, Woutput, mode, batch_size, num_stacks)
